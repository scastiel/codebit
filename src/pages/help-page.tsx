  ...
  return (
    <div className="flex-1 flex flex-col">
      ...
      <main className="w-full my-10 px-4 max-w-screen-lg mx-auto prose dark:prose-invert lg:prose-xl">
        ...
        <p>
          In CodeBit, a code animation is called a <strong>snippet</strong>,
          which contains several <strong>steps</strong>, i.e. several versions
          of the code.
        </p>
...
\`\`\``}</code>
        ...
        <p>
          ...
          at top. You can also define several files in your snippets, creating
          an animation when switching from one file to another.
        </p>
...
\`\`\``}</code>
        ...
        <ul>
          ...
          <li>
            <code>animatedBackground</code>: whether the background is animated
            or not. Default is <code>true</code>, set it to <code>false</code>{' '}
            to disable.
          </li>
          <li>
        ...
        <p>
          ...
          exhausting, as a tiny change at the beginning forces you to change
          every step after.
        </p>

        <p>
          Here are a few tips we discovered when using our application to make
          it easier:
        </p>
        ...
        <ol>
          <li>
            ...
            your explanation, and end with steps that are here only for
            animation tweaking.
          </li>
          <li>
            If the animation isn’t exactly the one you want, add extra steps.
            For instance, if a step adds a line of code between two lines, it
            might look nicer if you first add an empty line, then add the line
            content:
          </li>
        </ol>
...
\`\`\``}</code>
        ...
        <p>
          ...
          If anything is unclear or if you want to share any other tips, shout
          us an email at{' '}
